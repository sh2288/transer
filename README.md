...
### 文字游戏_翻译君_2024-02-20 (测试版暂时在QQ群里发布)![image](https://img.shields.io/badge/官方QQ群-574054671-ff69b4?style=flat&logo=tencent-qq)

更新说明

- [x]   添加文件拖放功能(单或多文件拖放到剧本列表,再点击提取按钮即可)
- [x]   修复Rpgmv,json Parameters值可能为null时无法提取和导出的bug
